...
def networkLib():
    ...
    if len(libios[1]) != 0:
       try:
        urlretrieve("https://github.com/Impact-I/reFlutter/releases/download/ios-"+libios[1]+"/Flutter", "Flutter")
       except:
        libios='',''
    if len(libAppArm64[1]) != 0:
       try: 
        urlretrieve("https://github.com/Impact-I/reFlutter/releases/download/android-"+libAppArm64[1]+"/libflutter_arm64.so", "libflutter_arm64.so")
       except:
        libAppArm64='',''
    if len(libAppArm[1]) != 0:
       try:
        urlretrieve("https://github.com/Impact-I/reFlutter/releases/download/android-"+libAppArm[1]+"/libflutter_arm.so", "libflutter_arm.so")
       except:
        libAppArm='',''
    if len(libAppX64[1]) != 0:
       try:
        urlretrieve("https://github.com/Impact-I/reFlutter/releases/download/android-"+libAppX64[1]+"/libflutter_x64.so", "libflutter_x64.so")
       except:
        libAppX64='',''       
    if len(libAppX86[1]) != 0:
       try:
        urlretrieve("https://github.com/Impact-I/reFlutter/releases/download/android-"+libAppX86[1]+"/libflutter_x86.so", "libflutter_x86.so")
       except:
        libAppX86='',''
    patchLibrary()
